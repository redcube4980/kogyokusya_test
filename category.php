  ...
  <div id="container" class="cf school-life">
        ...
        <div id="main" class="news-list-main">
			...
			<div class="sidebar-banner">
				<a href=""><img class="top-pass-banner-img" src="<?php echo get_template_directory_uri();?>/img/pass-banner.png" alt="pass-banner"></a>
			</div>
			<div class="sidebar-banner">
            ...
            <div class="right-wrap">
                <div class="ttl-area">
                    <h2 class="news-list-ttl"><?php echo $current_category; ?></h2>
                </div>
