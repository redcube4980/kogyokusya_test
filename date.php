  ...
  <div id="container" class="cf school-life">
        ...
        <div id="main" class="news-list-main">
			...
			<div class="sidebar-banner">
				<img class="sidebar-banner-img" src="<?php echo get_template_directory_uri();?>/img/bunner.png" alt="bunner">
			</div>
			</div>
            <div class="right-wrap">
                <div class="ttl-area">
                    <h2 class="news-list-ttl"><?php the_archive_title( $before, $after ); ?>の記事一覧</h2>
				</div>
